...
| `set_request_configuration(AdmobConfig)` | Sets the general configuration applied to all ad requests |
| `get_initialization_status()` | Gets the initialization status of enabled mediation networks |
