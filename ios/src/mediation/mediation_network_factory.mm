...
+ (MediationNetwork *)createNetwork:(NSString *)networkTag {
	NSString *tag =
			[[networkTag stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]] lowercaseString];

	static NSDictionary<NSString *, MediationNetwork * (^)(void)> *networkFactoryMap = nil;
	static dispatch_once_t onceToken;
		dispatch_once(&onceToken, ^{
		networkFactoryMap = @{ GoogleMediationNetwork.TAG : ^{
				return [[GoogleMediationNetwork alloc] init];
			},
			ApplovinMediationNetwork.TAG: ^{
		return [[ApplovinMediationNetwork alloc] init];
			},
			ChartboostMediationNetwork.TAG: ^{
		return [[ChartboostMediationNetwork alloc] init];
			},
			DtexchangeMediationNetwork.TAG: ^{
		return [[DtexchangeMediationNetwork alloc] init];
			},
			ImobileMediationNetwork.TAG: ^{
		return [[ImobileMediationNetwork alloc] init];
			},
			InmobiMediationNetwork.TAG: ^{
		return [[InmobiMediationNetwork alloc] init];
			},
			IronsourceMediationNetwork.TAG: ^{
		return [[IronsourceMediationNetwork alloc] init];
			},
			LiftoffMediationNetwork.TAG: ^{
		return [[LiftoffMediationNetwork alloc] init];
			},
			LineMediationNetwork.TAG: ^{
		return [[LineMediationNetwork alloc] init];
			},
			MaioMediationNetwork.TAG: ^{
		return [[MaioMediationNetwork alloc] init];
			},
			MetaMediationNetwork.TAG: ^{
		return [[MetaMediationNetwork alloc] init];
			},
			MintegralMediationNetwork.TAG: ^{
		return [[MintegralMediationNetwork alloc] init];
			},
			MolocoMediationNetwork.TAG: ^{
		return [[MolocoMediationNetwork alloc] init];
			},
			MytargetMediationNetwork.TAG: ^{
		return [[MytargetMediationNetwork alloc] init];
			},
			PangleMediationNetwork.TAG: ^{
		return [[PangleMediationNetwork alloc] init];
			},
			UnityMediationNetwork.TAG: ^{
		return [[UnityMediationNetwork alloc] init];
			}
};
});
